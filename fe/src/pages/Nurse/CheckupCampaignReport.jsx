...
const CheckupCampaignReport = () => {
  ...
  const toggleDropdown = (registerId) => {
              ...
              {list.length === 0 ? (
                ...
                list.map((item) => (
                  <tr key={item.register_id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(item.register_status)}`}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 relative">
                      <button
                        onClick={() => toggleDropdown(item.register_id)}
                        className="text-gray-600 hover:text-gray-900"
                      >
                        <Eye className="h-5 w-5" />
                      </button>
                      {dropdownOpen[item.register_id] && (
